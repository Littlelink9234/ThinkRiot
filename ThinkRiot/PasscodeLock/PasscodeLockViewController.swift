...
public class PasscodeLockViewController: UIViewController, PasscodeLockTypeDelegate {
    ...
    private func setupEvents() {
        ...
        notificationCenter?.addObserver(self, selector: Selector(("appWillEnterForegroundHandler:")), name: NSNotification.Name.UIApplicationWillEnterForeground, object: nil)
        notificationCenter?.addObserver(self, selector: Selector(("appDidEnterBackgroundHandler:")), name: NSNotification.Name.UIApplicationDidEnterBackground, object: nil)
    }
